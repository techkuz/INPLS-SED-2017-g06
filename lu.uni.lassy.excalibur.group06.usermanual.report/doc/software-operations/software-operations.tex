...
A human kind provides  information  (last/first  name,  telephone number)  to  the  iCrash administrator  about  its  emergency  contacts (family). Administrator  adds  this information  to  the  iCrash  database.
